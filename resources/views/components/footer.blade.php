<footer class="bg-[#241B16] text-[#F5EFE2] pt-16 pb-12 border-t-4 border-[#C9A227]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="flex items-center space-x-3 bg-white/5 p-2 rounded-xl w-fit">
                    <img src="/logo/Logo_Final.png" alt="Raso Mandeh Logo" class="w-56 h-auto object-contain">
                </div>
            ...
            <div class="lg:col-span-2 space-y-3">
                <h4 class="font-serif font-bold text-base text-[#C9A227]">Navigasi</h4>
                <ul class="space-y-2 text-sm text-white/75">
                    <li><a href="#menu" class="hover:text-[#C9A227] transition-colors">Daftar Menu</a></li>
                    <li><a href="#cabang" class="hover:text-[#C9A227] transition-colors">Pilihan Cabang</a></li>
                    <li><a href="#cerita" class="hover:text-[#C9A227] transition-colors">Sejarah Kami</a></li>
                    <li><a href="#ulasan" class="hover:text-[#C9A227] transition-colors">Ulasan Pelanggan</a></li>
                </ul>
            </div>

            <!-- Operating Hours -->
            <div class="lg:col-span-3 space-y-3">
                <h4 class="font-serif font-bold text-base text-[#C9A227]">Jam Operasional</h4>
                <div class="space-y-2 text-sm text-white/75">
                    <p><strong class="text-white">Senin - Minggu:</strong><br>09:00 - 22:00 WIB</p>
                    <p><strong class="text-white">Cabang Bukittinggi:</strong><br>08:00 - 22:00 WIB</p>
                    <p class="text-xs text-white/60">Menerima pesanan katering, nasi kotak, dan acara pernikahan.</p>
                </div>
            </div>
